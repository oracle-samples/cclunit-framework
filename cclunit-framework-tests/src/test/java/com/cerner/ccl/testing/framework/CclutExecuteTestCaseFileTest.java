...
/**
 * Tests for the {@code cclut_execute_test_case_file.prg} script.
 *
 * @author Fred Eckertson
 *
 */

public class CclutExecuteTestCaseFileTest extends AbstractCclutTest {
    private static final Logger LOGGER = LoggerFactory.getLogger(CclutExecuteTestCaseFileTest.class);
    ...
    public void setUp() {
        final Structure programsRequestStructure = StructureBuilder.getBuilder().addVC("programName").addI2("compile")
                .build();
        final Structure requestStructure = StructureBuilder.getBuilder().addVC("testCaseDirectory")
                .addVC("testCaseFileName")
        ...
        final Structure replyStructure = StructureBuilder.getBuilder().addVC("environmentXML").addVC("listingXML")
                .addVC("coverageXML").addVC("resultsXML").addDynamicList("programs", programsReplyStructure)
                .addStatusData().build();
    ...
    public void testBadSyntaxIncludeFile() {
        ...
        setRequestTestCase(includeFileName);

        final CclExecutor executor = getCclExecutor();
        executor.addScriptExecution("cclut_execute_test_case_file").withReplace("cclutRequest", request)
        ...
        assertThat(subeventStatus.getChar("TargetObjectName").trim()).isEqualTo("cclut_execute_test_case_file");
    ...
    public void testFailWithAssertionFailure() throws Exception {
        ...
        final String testCaseFileName = "cclut_test_with_assertion_failure.inc";

        setRequestTestCase(testCaseFileName);
        addRequestProgram(programName);

        final CclResourceUploader uploader = getResourceUploader();
        uploader.queueUpload(new File(getTestResourceDirectory(), testCaseFileName));
        ...
        final TESTCASE testCaseFile = (TESTCASE) jaxbContext.createUnmarshaller()
                .unmarshal(new StringReader(reply.getVC("resultsXml")));
        assertThat(testCaseFile.getNAME()).isEqualTo(testCaseFileName);

        final List<TEST> tests = testCaseFile.getTESTS().getTEST();
        ...
        assertThat(assertion.getCONDITION()).isEqualTo("1=0");
    }
    ...
    public void testFailWithTestRuntimeError() throws Exception {
        final String programName = "cclutDummyTest";
        final File programFile = new File(getTestResourceDirectory(), programName + ".prg");
        final String testCaseFileName = "cclut_test_with_runtime_error.inc";
    ...
    public void testExecuteWithPredeclare() throws Exception {
        final String programName = "cclutDummyTest";
        final File programFile = new File(getTestResourceDirectory(), programName + ".prg");
        final String testCaseFileName = "cclut_test_without_declare.inc";
        ...
        setRequestTestCase(testCaseFileName, withEnforcePredeclareRequest);

        final CclExecutor executor = getCclExecutor();
        executor.addScriptCompiler(programFile).commit();
        executor.addScriptExecution("cclut_execute_test_case_file")
                .withReplace("cclutRequest", withEnforcePredeclareRequest).withReplace("cclutReply", reply).commit();
        executor.addScriptDropper(programName).commit();
        executor.execute();
    ...
    public void testExecuteWithoutPredeclare() throws Exception {
        ...
        setRequestTestCase(testCaseFileName, withoutEnforcePredeclareRequest);
    ...
    public void testExecuteWithPredeclareFalse() throws Exception {
        ...
        setRequestTestCase(testCaseFileName, withEnforcePredeclareFalseRequest);
        ...
        final TESTCASE testCase = (TESTCASE) jaxbContext.createUnmarshaller()
                .unmarshal(new StringReader(reply.getVC("resultsXml")));
        assertThat(testCase.getNAME()).isEqualTo(testCaseFileName);
     ...
     */
    @Test
    public void testExecuteWithTestNamePattern() throws Exception {
        final String programName = "cclutDummyTest";
        final File programFile = new File(getTestResourceDirectory(), programName + ".prg");
        final String testCaseFileName = "cclut_test_filter_sub_name.inc";
        ...
        final Structure testStructure = StructureBuilder.getBuilder(request.getStructure()).addVC("testNamePattern")
                .build();
        final Record testRecord = RecordFactory.create("testCasePatternRequest", testStructure);
        testRecord.setVC("testNamePattern", "dorun");
        addRequestProgram(programName, testRecord);
        setRequestTestCase(testCaseFileName, testRecord);

        final CclExecutor executor = getCclExecutor();
        executor.addScriptCompiler(programFile).commit();
        executor.addScriptExecution("cclut_execute_test_case_file").withReplace("cclutRequest", testRecord)
                .withReplace("cclutReply", reply).commit();
        executor.addScriptDropper(programName).commit();
        executor.execute();
        ...
        assertThat(testOne.getNAME()).isEqualTo("TESTDORUNONE");
        final TEST testTwo = tests.get(1);
        assertThat(testTwo.getNAME()).isEqualTo("TESTDORUNTWO");
    }
    ...
    public void testGetTestName() {
        ...
        final String testCaseFileName = "cclut_test_get_test_name.inc";
    ...
    public void testSucceedWithAssertion() throws Exception {
        final String programName = "cclutDummyTest";
        final File programFile = new File(getTestResourceDirectory(), programName + ".prg");
        final String testCaseFileName = "cclut_test_with_assertion_success.inc";
        ...
        assertThat(assertion.getCONDITION()).isEqualTo("1=1");
    }

    /**
     * Test the execution of a test case with all-successful assertions and the request set to return the results in the
     * legacy format.
     *
     * @throws Exception
     *             If any errors occur during the test run.
     */
    @Test
    public void testSucceedWithAssertionLegacy() throws Exception {
        final String programName = "cclutDummyTest";
        final File programFile = new File(getTestResourceDirectory(), programName + ".prg");
        final String testCaseFileName = "cclut_test_with_assertion_success.inc";
        ...
        final Structure withLegacyResultsFormat = StructureBuilder.getBuilder(request.getStructure())
                .addI2("legacyResultsFormat").build();
        final Record withLegacyResultsFormatRequest = RecordFactory.create("withLegacyResultsFormatRequest",
                withLegacyResultsFormat);
        withLegacyResultsFormatRequest.setI2("legacyResultsFormat", true);

        addRequestProgram(programName, withLegacyResultsFormatRequest);
        setRequestTestCase(testCaseFileName, withLegacyResultsFormatRequest);

        final CclExecutor executor = getCclExecutor();
        executor.addScriptCompiler(programFile).commit();
        executor.addScriptExecution("cclut_execute_test_case_file")
                .withReplace("cclutRequest", withLegacyResultsFormatRequest).withReplace("cclutReply", reply).commit();
        executor.addScriptDropper(programName).commit();
        executor.execute();
        ...
        final List<TESTCASE.TESTS.TEST> tests = testCaseFile.getTESTS().getTEST();
        assertThat(tests).hasSize(1);
        final TESTCASE.TESTS.TEST test = tests.get(0);
        assertThat(test.getNAME()).isEqualTo("TESTWITHASSERTIONSUCCESS");
        assertThat(test.getRESULT()).isEqualTo("PASSED");

        final List<TESTCASE.TESTS.TEST.ASSERTS.ASSERT> assertions = test.getASSERTS().getASSERT();
        assertThat(assertions).hasSize(1);

        final TESTCASE.TESTS.TEST.ASSERTS.ASSERT assertion = assertions.get(0);
        assertThat(assertion.getCONTEXT()).isEqualTo("this should succeed");
        assertThat(assertion.getRESULT()).isEqualTo("PASSED");
    ...
    /**
     * Set the test case {@code .inc} file to be executed by the framework on the default request structure.
     *
     * @param testCaseFileName
     *            The name (with or without the {@code .inc} file extension) of the test case to be executed.
     */
    private void setRequestTestCase(final String testCaseFileName) {
        setRequestTestCase(testCaseFileName, request);
    }

    /**
     * Set the test case {@code .inc} file to be executed by the framework on a given request record structure.
     *
     * @param testCaseFileName
     *            The name (including the {@code .inc} file extension) of the test case to be executed.
     * @param request
     *            The {@link Record} whose test INC name is to be set.
     */
    private void setRequestTestCase(final String testCaseFileName, final Record request) {
        // FUTURE: switch to cer_temp or don't even bother setting this once the uploader is able
        // to upload to a specified directory (i.e., doesn't send all .inc files to cclsource)
        request.setVC("testCaseDirectory", "cclsource");
        request.setVC("testCaseFileName", testCaseFileName);
    }
     ...
     *             If any errors occur during the test run.
     */
    private void validateXml(final String testCaseFileName, final String... programs) throws Exception {
        final CclResourceUploader uploader = getResourceUploader();
        uploader.queueUpload(new File(getTestResourceDirectory(), testCaseFileName));
        ...
        listingSchema.newValidator().validate(new StreamSource(new StringReader(reply.getVC("listingXml"))));
        ...
        coverageSchema.newValidator().validate(new StreamSource(new StringReader(reply.getVC("coverageXml"))));
        ...
        testResults.newValidator().validate(new StreamSource(new StringReader(reply.getVC("resultsXml"))));
    }
    ...
    public void testSucceedWithTimers() throws Exception {
        final String programName = "cclutDummyTest";
        final File programFile = new File(getTestResourceDirectory(), programName + ".prg");
        final String testCaseFileName = "cclut_test_timer_success.inc";
        ...
        assertThat(assertionOneOne.getCONDITION()).contains("<=1.500000");
        ...
        assertThat(assertionOneTwo.getCONDITION()).contains("<=2.500000");
        ...
        assertThat(assertionTwoOne.getCONDITION()).contains("<=1.250000");
        ...
        assertThat(assertionTwoTwo.getCONDITION()).contains("<=2.250000");
    }
    ...
    public void testFailWithDuplicateTimers() throws Exception {
        final String programName = "cclutDummyTest";
        final File programFile = new File(getTestResourceDirectory(), programName + ".prg");
        final String testCaseFileName = "cclut_test_timer_fail_duplicate.inc";
    ...
    public void testFailWithExpiredTimers() throws Exception {
        final String programName = "cclutDummyTest";
        final File programFile = new File(getTestResourceDirectory(), programName + ".prg");
        final String testCaseFileName = "cclut_test_timer_fail_expired.inc";
        ...
        assertThat(assertionOneTwo.getCONDITION()).contains("<=1.750000");
        ...
        assertThat(assertionOneThree.getCONDITION()).contains("<=3.250000");
    }
}

drop program cclutAssertTestNotEqual go
create program cclutAssertTestNotEqual
...
set reply->f8EqualResponse = cclutAssertf8NotEqual(1, "f8Equal", 
    request->f8Equal.value, request->f8Equal.value)
set reply->f8InequalResponse = cclutAssertf8NotEqual(2, "f8Inequal",
    request->f8Inequal.expected, request->f8Inequal.actual)
    
set reply->i4EqualResponse = cclutAsserti4NotEqual(3, "i4Equal",
    request->i4Equal.value, request->i4Equal.value)
set reply->i4InequalResponse = cclutAsserti4NotEqual(4, "i4Inequal",
    request->i4Inequal.expected, request->i4Inequal.actual)

set reply->i2EqualResponse = cclutAsserti2NotEqual(5, "i2Equal",
    request->i2Equal.value, request->i2Equal.value)
set reply->i2InequalResponse = cclutAsserti2NotEqual(4, "i2Inequal",
    request->i2Inequal.expected, request->i2Inequal.actual)

set reply->vcEqualResponse = cclutAssertvcNotEqual(6, "vcEqual",
    request->vcEqual.value, request->vcEqual.value)
set reply->vcInequalResponse = cclutAssertvcNotEqual(7, "vcInequal",
    request->vcInequal.expected, request->vcInequal.actual)

set reply->dateEqualResponse = cclutAssertdatetimeNotEqual(8, "dateEqual",
    request->dateEqual.value, request->dateEqual.value)
set reply->dateInequalResponse = cclutAssertdatetimeNotEqual(9, "dateInequal",

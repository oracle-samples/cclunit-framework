drop program cclutAssertTestLessThan go
create program cclutAssertTestLessThan
...
set reply->f8LessThanResponse = cclutAssertf8LessThan(1, "f8LessThan", 
    request->f8LessThan.value, request->f8LessThan.value + 1)
set reply->f8NotLessThanResponse = cclutAssertf8LessThan(2, "f8NotLessThan",
    request->f8NotLessThan.value, request->f8NotLessThan.comparisonValue)
    
set reply->i4LessThanResponse = cclutAsserti4LessThan(3, "i4LessThan",
    request->i4LessThan.value, request->i4LessThan.value + 1)
set reply->i4NotLessThanResponse = cclutAsserti4LessThan(4, "i4NotLessThan",
    request->i4NotLessThan.value, request->i4NotLessThan.comparisonValue)

set reply->i2LessThanResponse = cclutAsserti2LessThan(5, "i2LessThan",
    request->i2LessThan.value, request->i2LessThan.value + 1)
set reply->i2NotLessThanResponse = cclutAsserti2LessThan(4, "i2NotLessThan",
    request->i2NotLessThan.value, request->i2NotLessThan.comparisonValue)

set reply->vcLessThanResponse = cclutAssertvcLessThan(6, "vcLessThan",
    request->vcLessThan.value, concat(request->vcLessThan.value, "a"))
set reply->vcNotLessThanResponse = cclutAssertvcLessThan(7, "vcNotLessThan",
    request->vcNotLessThan.value, request->vcNotLessThan.comparisonValue)

set reply->dateLessThanResponse = cclutAssertdatetimeLessThan(8, "dateLessThan",
    request->dateLessThan.value, datetimeadd(request->dateLessThan.value, 1))
set reply->dateNotLessThanResponse = cclutAssertdatetimeLessThan(9, "dateNotLessThan",

drop program cclutGetChildAttrValTest go
create program cclutGetChildAttrValTest
...
set dt_reply->val = cclut::getXmlChildNodeAttributeValue(dt_handle, dt_request->child3Name, dt_request->attrName)

...
subroutine cclut::findUnitTests(cclutProgramName, cclutUnitTests)
  ...
  declare cclutUnitTestCount     = h with protect, noconstant(0)
  ...
  declare cclutSubroutineCount   = h with protect, noconstant(1)
  declare cclutErrorMessage      = vc with protect, noconstant("")
  declare cclStat                = h with protect, noconstant(0)

...
subroutine cclut::findUnitTests(cclutProgramName, cclutUnitTests)
  ...
  declare cclutHXmlFile          = i4 with protect, noconstant(0)
  declare cclutUnitTestCount     = i4 with protect, noconstant(0)
  declare cclutHProgram          = i4 with protect, noconstant(0)
  declare cclutHSubroutine       = i4 with protect, noconstant(0)
  declare cclutHName             = i4 with protect, noconstant(0)
  declare cclutHNamespace        = i4 with protect, noconstant(0)

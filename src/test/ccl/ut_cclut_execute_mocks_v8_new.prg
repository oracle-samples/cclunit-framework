;******************************************************************************
; This program is for unit testing test_cclutExecuteProgramWithMocks_v8_new.  *
; It overrides cclutGetCurrentVersion to return 81500 and                     *
; cclutGetCurrentRevision to return 8.                                        *
;******************************************************************************
drop program ut_cclut_execute_mocks_v8_new:dba go
create program ut_cclut_execute_mocks_v8_new:dba
